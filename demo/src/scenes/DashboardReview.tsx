...
// Page 6｜後台審核（接在 ResultReveal 之後，FullVideo 最後一段，13 秒）。素材來自
// 使用者提供的真實後台儀表板截圖（demo/all1/*.png，另一位成員架設，不在這個 repo
// 裡，沒有原始碼可讀）。精選重點元素做動態化，不是逐像素還原截圖版面：延續第一支
// 影片自己的深色科技風視覺語言（跟第二支影片「忠實還原亮色 App 截圖」刻意不同），
// 用截圖裡的真實文案/資料結構重新設計成跟其他 5 段一致的深色卡片風格。
//
...
// 座標跟 ResultReveal.tsx 的 BOXES／PhoneResult.tsx 的 DAMAGE_BOXES 完全一致
// （同一張 front_left.png、同一組刮傷/凹痕位置），三個地方共用同一份案件資料。
      ...
      <AbsoluteFill style={{ flexDirection: 'column', alignItems: 'center', paddingTop: 80 }}>
        ...
        <div style={{ flex: 1, position: 'relative', width: '100%' }}>
          ...
          >
            ...
            >
              <div style={{ position: 'relative', width: 600, overflow: 'hidden', borderRadius: 2 }}>
                <Img
